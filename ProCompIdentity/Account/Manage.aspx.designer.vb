...
Partial Public Class Manage
    ...
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents btnRemoveAdmin As Global.System.Web.UI.WebControls.Button
    
    '''<summary>
    '''btnBecomeAdmin control.
    '''</summary>
    '''<remarks>
    '''Auto-generated field.
    '''To modify move field declaration from designer file to code-behind file.
    '''</remarks>
    Protected WithEvents btnBecomeAdmin As Global.System.Web.UI.WebControls.Button
End Class
